...
load File.expand_path('../app/topic_store.rb', __FILE__)

after_initialize do
	load File.expand_path('../app/controllers/discourse-topic-organizer_controller.rb', __FILE__)
	load File.expand_path('../app/controllers/custom-public-button_controller.rb', __FILE__)
